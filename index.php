...
<body>
	...
	<div class="site-content">
		...
		<div class="hero" data-bg-image="<?= $hostToRoot ?>wp-content/images/bg.jpg">
			<div class="container">
				<form action="#" class="find-location">
					<input type="text" placeholder="Cari Lokasi Lain...">
		...
		<div class="forecast-table">
			<div class="container">
				<div class="forecast-container">
					<div class="today forecast bungkus">
						<div class="forecast-header">
							<div class="day ">Senin</div>
							<div class="date tglHari"></div>
						</div>
					...
					<div class="forecast hilangkan">
						<div class="forecast-header">
							<div class="day">Selasa</div>
						</div> <!-- .forecast-header -->
						<div class="forecast-content">
							<div class="forecast-icon">
								<img src="<?= $hostToRoot ?>wp-content/images/icons/3.svg" alt="" width=48>
							</div>
							<div class="degree">21<sup>o</sup>C</div>
						</div>
					</div>
					<div class="forecast">
						<div class="forecast-header">
						...
						<div class="forecast-content">
							<div class="forecast-icon">
								<img src="<?= $hostToRoot ?>wp-content/images/icons/102.svg" alt="" width=48>
							</div>
					...
					<div class="forecast">
						...
						<div class="forecast-content">
							<div class="forecast-icon">
								<img src="<?= $hostToRoot ?>wp-content/images/icons/1.svg" alt="" width=48>
							</div>
					...
					<div class="forecast">
						...
						<div class="forecast-content">
							<div class="forecast-icon">
								<img src="<?= $hostToRoot ?>wp-content/images/icons/0.svg" alt="" width=48>
							</div>
							<div class="degree">22<sup>o</sup>C</div>
						</div>
					</div>
					<div class="forecast">
						<div class="forecast-header">
						...
						<div class="forecast-content">
							<div class="forecast-icon">
								<img src="<?= $hostToRoot ?>wp-content/images/icons/60.svg" alt="" width=48>
							</div>
							<div class="degree">20<sup>o</sup>C</div>
						</div>
					</div>
				</div>
			</div>
